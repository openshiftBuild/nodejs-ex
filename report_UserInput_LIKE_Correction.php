...
<form method="post" action="report_UserInput_LIKE_Correction.php" name="LIKEform" id="LIKEform">
  <fieldset>
...
echo '<p style="color:Red; font-size:24px;text-align:center;">Sorry.  Please enter one of the following region names:<br/>"Midwest", "Northeast", "South", or "West".</p>';
