...
<p>Syntax:<br/>SELECT Region, State,Division, Rate from 
 unEmpRate WHERE Region='$userInput2' or Region LIKE '%$userInput3%' ORDER BY State, Rate</p>
...
<form method="post" action="report_UserInput_LIKE_DropDown3.php" name="LIKEform" id="LIKEform">
  <fieldset>
...
else
{
 ...
 unEmpRate WHERE Region='$userInput2' or Region LIKE '%$userInput3%' ORDER BY State, Rate");
...
<br/>
      ...
      <button type="button" onClick="location.href='report_UserInput_LIKE_DropDown3.php'">Return to Form</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
