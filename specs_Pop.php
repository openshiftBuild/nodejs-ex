...
<h3 style="text-align:center;">Table Specs for State Population&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" onClick="location.href='Reports.php'">Return to Reports</button></h3>
...
$res = mysql_query('DESCRIBE statePop');
