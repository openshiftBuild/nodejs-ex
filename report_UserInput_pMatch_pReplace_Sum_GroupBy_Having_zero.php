...
<form method="post" action="report_UserInput_pMatch_pReplace_Sum_GroupBy_Having_zero.php" name="popform" id="popform">
  <fieldset>
...
<br/>
<br/>
<button type="button" onClick="location.href='report_UserInput_pMatch_pReplace_Sum_GroupBy_Having_zero.php'">Try Again</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<br/>
      ...
      <button type="button" onClick="location.href='report_UserInput_pMatch_pReplace_Sum_GroupBy_Having_zero.php'">Return to Form</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
