...
<p>Syntax:<br/>SELECT Region, State,Division, Rate from unEmpRate WHERE Region LIKE '%$userInput1%' ORDER BY Region, State, Rate;</p>
...
<form method="post" action="report_UserInput_LIKE_Programming.php" name="LIKEform" id="LIKEform">
  <fieldset>
...
else
{
 ...
 unEmpRate WHERE Region LIKE '%$userInput1%' ORDER BY Region, State, Rate");
...
<br/>
      ...
      <button type="button" onClick="location.href='report_UserInput_LIKE_Programming.php'">Return to Form</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
