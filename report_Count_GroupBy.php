...
<head>
  ...
  <title>Report: COUNT() and GROUP BY</title>
...
<br/>
<h3 style="text-align:center;">COUNT() and GROUP BY</h3>

<p>Using COUNT() to count the number of states listed in the table and Group them by Region and Division</p>

<p>Syntax:<br/>SELECT Region, Division, COUNT( state ) FROM  `unEmpRate GROUP BY Region, Division;</p>
...
else
{
 ...
 echo '<br/>';
     	...
     	$SpecsQuery1 = mysql_query("SELECT Region, Division, COUNT(state) 
FROM  `unEmpRate` 
...
<p>Note: Also includes the District of Columbia in the South Atlantic Division.</p>
