...
<form method="post" action="report_UserInput_LIKE_Correction2.php" name="LIKEform" id="LIKEform">
  <fieldset>
...
if($userInput1 == $MW || $userInput1 == $NE || $userInput1 == $S || $userInput1 == $W)
{
...
<br/>
      ...
      <button type="button" onClick="location.href='report_UserInput_LIKE.php'">Return to Form</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<p style="color:Red; font-size:24px;text-align:center;">Sorry.  Please enter one of the following region names:<br/>"Midwest", "Northeast", "South", or "West"</p>
<br/>
<button type="button" onClick="location.href='report_UserInput_LIKE_Correction2.php'">Return to Form</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
