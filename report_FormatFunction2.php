...
<form method="post" action="report_FormatFunction2.php" name="formatform" id="formatform">
  <fieldset>
...
<br/>
      ...
      <button type="button" onClick="location.href='report_FormatFunction2.php'">Try Again</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<br/>
      ...
      <button type="button" onClick="location.href='report_FormatFunction2.php'">Return to Form</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
