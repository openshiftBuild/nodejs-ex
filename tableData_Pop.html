...
<br/>
<h3 style="text-align:center;">Table Data for U.S. Population by State&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" onClick="location.href='Reports.php'">Return to Reports</button></h3>
...
else
{
 ...
 echo '<br/>';
     	...
     	$SpecsQuery1 = mysql_query("SELECT Region, State, Division,Year,Population from 
 statePop ORDER BY State, Population");
