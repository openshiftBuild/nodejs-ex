...
<p>Using LIKE, provides data according to user input.  Using HTML, the user is required to select from a preset list of region names.</p>

<p>Syntax:<br/>SELECT Region, State,Division, Rate from 
 unEmpRate WHERE Region='$userInput2' or Region LIKE '%$userInput3%' ORDER BY Region, State, Rate</p>
...
<form method="post" action="report_UserInput_LIKE_DropDown.php" name="LIKEform" id="LIKEform">
  <fieldset>
...
<option value="WestMidwest">contains "west"</option>
</select>
...
else
{
 ...
 unEmpRate WHERE Region='$userInput2' or Region LIKE '%$userInput3%' ORDER BY Region, State, Rate");
...
<br/>
      ...
      <button type="button" onClick="location.href='report_UserInput_LIKE_DropDown.php'">Return to Form</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
