...
<head>
  ...
  <title>Report: SUM() and GROUP BY</title>
...
<br/>
<h3 style="text-align:center;">SUM() and GROUP BY</h3>

<p>Using SUM() and GROUP BY, U.S. Population is Presented by Region</p>

<p>Syntax:<br/>SELECT Region, SUM(Population) 
FROM statePop GROUP BY Region;</p>
