...
<br/>
<h3 style="text-align:center;">Table Data for unEmpRate&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" onClick="location.href='Reports.php'">Return to Reports</button></h3>
...
else
{
 ...
 echo '<br/>';
     	...
     	$SpecsQuery1 = mysql_query("SELECT Region, State,Division, Year, Rate, totallaborGrants from 
 unEmpRate ORDER BY State, Rate");
