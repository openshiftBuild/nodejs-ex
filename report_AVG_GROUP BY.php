...
<head>
  ...
  <title>Report: AVG() and GROUP BY</title>
...
<br/>
<h3 style="text-align:center;">AVG() and GROUP BY</h3>

<p>Using AVG() and GROUP BY the Average unemployment Rate is presented by Region and Division</p>

<p>Syntax:<br/>

SELECT Region, Division, AVG( Rate ) FROM unEmpRate GROUP BY Region, Division</p>
...
else
{
 ...
 echo '<br/>';
     	...
     	$SpecsQuery1 = mysql_query("SELECT Region, Division, AVG(Rate) FROM  unEmpRate GROUP BY Region, Division");
