...
<p>Using SUM(), GROUP BY, and HAVING provide population grouped by region.  Using the HAVING clause, only those regions with a population > 70 million are included.</p>

<p>Syntax:<br/>SELECT Region, SUM( Population ) 
FROM statePop GROUP BY Region HAVING SUM( Population ) > 70000000</p>
