...
<?php
if(!empty($_POST['company']) || !empty($_POST['view2']))
{
...
if (!$db_selected) {
    die ('Cannot use database');
     	...
     	$registerquery = mysql_query("INSERT INTO Prospective_Employer (Company,Fname,Lname,EmailAddress,Anonymous) VALUES(
...
<form method="post" action="webApp_Anonymous.php" name="entranceform" id="entranceform">
  <fieldset>
...
<label for="company">Name of Company:<br/></label><input type="text" name="company" id="company"  size="30"/> <br><br />


<label for="fname">First Name:<br/></label><input type="text" name="fname" id="fname" size="30"/> <br><br />


<label for="lname">Last Name:<br/></label><input type="text" name="lname" id="lname"size="30"/> <br><br />


<label for="email">Email:<br/></label><input type="text" name="email" id="email"  size="30"/> <br><br />
